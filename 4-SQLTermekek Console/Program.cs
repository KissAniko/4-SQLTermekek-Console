...
namespace _4_SQLTermekek_Console
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Listázza ki azoknak a 'gyártó'knak a neveit, ahol legalább
            // 40 fajta termék szerepel monitorból! (kategória -> monitor)

            string SQLselect = "SELECT Gyártó, COUNT(*) as Darab" +
                              " FROM termékek " +
                              "WHERE Kategória = \"Monitor\" " +
                              "GROUP BY `Kategória` " +
                              "HAVING Darab>=40";
